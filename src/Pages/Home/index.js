...
const Home = (props) => {
  ...
  const tableData = [
    { level: 1, percentage: "52%", team: ref_data1[0], earning: ref_data[0]/10**6 },
    { level: 2, percentage: "2%", team: ref_data1[1], earning: ref_data[1]/10**6},
    { level: 3, percentage: "2%", team: ref_data1[2], earning: ref_data[2]/10**6},
    { level: 4, percentage: "2%", team: ref_data1[3], earning: ref_data[3]/10**6},
    { level: 5, percentage: "2%", team: ref_data1[4], earning: ref_data[4]/10**6},
    { level: 6, percentage: "2%", team: ref_data1[5], earning: ref_data[5]/10**6},
    { level: 7, percentage: "2%", team: ref_data1[6], earning: ref_data[6]/10**6},
    { level: 8, percentage: "2%", team: ref_data1[7], earning: ref_data[7]/10**6},
    { level: 9, percentage: "2%", team: ref_data1[8], earning: ref_data[8]/10**6},
    { level: 10, percentage: "2%", team: ref_data1[9], earning: ref_data[9]/10**6},
    { level: 11, percentage: "2%", team: ref_data1[10], earning: ref_data[10]/10**6 },
    { level: 12, percentage: "2%", team: ref_data1[11], earning: ref_data[11]/10**6 },
    { level: 13, percentage: "2%", team: ref_data1[12], earning: ref_data[12]/10**6 },
    { level: 14, percentage: "2%", team: ref_data1[13], earning: ref_data[13]/10**6 },
    { level: 15, percentage: "2%", team: ref_data1[14], earning: ref_data[14]/10**6 },
    { level: 16, percentage: "2%", team: ref_data1[15], earning: ref_data[15]/10**6 },
    { level: 17, percentage: "2%", team: ref_data1[16], earning: ref_data[16]/10**6 },
    { level: 18, percentage: "2%", team: ref_data1[17], earning: ref_data[17]/10**6 },
    { level: 19, percentage: "2%", team: ref_data1[18], earning: ref_data[18]/10**6 },
    { level: 20, percentage: "2%", team: ref_data1[19], earning: ref_data[19]/10**6 },
    { level: 21, percentage: "2%", team: ref_data1[20], earning: ref_data[20]/10**6 },
    { level: 22, percentage: "2%", team: ref_data1[21], earning: ref_data[21]/10**6 },
    { level: 23, percentage: "2%", team: ref_data1[22], earning: ref_data[22]/10**6 },
    { level: 24, percentage: "2%", team: ref_data1[23], earning: ref_data[23]/10**6 },
    { level: 25, percentage: "2%", team: ref_data1[24], earning: ref_data[24]/10**6 },
